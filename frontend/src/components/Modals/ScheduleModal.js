      ...
      >
        ...
        >
          <Header>
            ...
            <p>Arrange pickup time and location with {recipient?.firstName} {recipient?.lastName}</p>
          </Header>

          <Content>
            <InfoBox>
              <p>
                💡 <strong>Tip:</strong> Click anywhere on the map to set the exact pickup location, 
                or search for an address. The recipient will be notified.
              </p>
            </InfoBox>
